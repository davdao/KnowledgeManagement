import { IDataFilter, IDataFilterResult } from "../models/search/IDataFilter";
import { FilterType, IDataFilterConfiguration } from "../models/search/IDataFilterConfiguration";
