...
import { IPropertyPanelSearchMetadataPropertyProps } from './IPropertyPanelSearchMetadataPropertyProps';
import MultiComboBoxSelector from '../../multiComboBoxSelector/MultiComboBoxSelector';

export interface IPropertyPanelSearchMetadataPropertyInternalProps extends IPropertyPanelSearchMetadataPropertyProps, IPropertyPaneCustomFieldProps {
}

export class PropertyPanelSearchMetadataProperty implements IPropertyPaneField<IPropertyPanelSearchMetadataPropertyProps> {
    public type: PropertyPaneFieldType = PropertyPaneFieldType.Custom;
    public targetProperty: string;
    public shouldFocus?: boolean;
    public properties: IPropertyPanelSearchMetadataPropertyInternalProps;
    private elem: HTMLElement;

    constructor(targetProperty: string, properties: IPropertyPanelSearchMetadataPropertyProps) {
    ...
    private onRender(elem: HTMLElement, ctx?: any, changeCallback?: (targetProperty?: string, newValue?: any) => void) {
        ...
        const element: React.ReactElement = React.createElement(MultiComboBoxSelector, {
            ...
            onUpdate: ((value: any) => { this.properties.onPropertyChange(this.targetProperty, value); }).bind(this),
